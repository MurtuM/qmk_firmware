// [victo@MurtumsMachine kyria]$ qmk flash -kb splitkb/kyria/rev1 -km murtum
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[LETTERS] = LAYOUT(
	...
	KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, XXXXXXX, XXXXXXX,                    XXXXXXX, XXXXXXX, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_LALT,
	        _______, _______, KC_LCTL, MO(NUMBERS), KC_LSFT,                    KC_BSPC, KC_SPC, MO(F_ROW), _______, DF(GAMING)),
	...
	MO(NAV), KC_A, KC_S, KC_D, KC_F, KC_G,                                                  KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
	KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, XXXXXXX, XXXXXXX,                    XXXXXXX, XXXXXXX, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_LALT,
	        _______, _______, KC_LCTL, MO(NUMBERS), KC_SPC,                    KC_BSPC, KC_SPC, MO(F_ROW), _______, DF(GAMING)),
    ...
    */
	...
	_______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,         XXXXXXX, XXXXXXX, KC_F3, _______, _______, _______, _______, _ROOF_NO_SHIT /*LSFT(KC_RBRC)^*/,
                      _______, _______, _______, _______, _______,                  KC_DEL, KC_ENT, XXXXXXX, XXXXXXX, XXXXXXX),
	...
	KC_CAPS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, XXXXXXX, XXXXXXX, XXXXXXX,             XXXXXXX, XXXXXXX, TG(GAMING), KC_MPLY, KC_MPRV, KC_MNXT, KC_PSCR, KC_PAUS,
...
bool oled_task_user(void) {
    if (is_keyboard_master()) {
        ...
        oled_invert(s_macro_rec);

        if (s_macro_rec)
        {
            oled_write_ln_P(PSTR("Recording:"), false);
        ...
        else
        {
            switch (get_highest_layer(layer_state|default_layer_state)) {
                ...
                case NAV:
                    ...
                    break;
                case F_ROW:
                    oled_write_ln_P(PSTR("F-Row"), false);
                    break;
                case GAMING:
                    oled_write_ln_P(PSTR("Gaming"), true);
                    break;
                default:
            ...
            // {
                // static char buf[6];
                // sprintf(buf, "(%u) %c", to_char(s_last_pressed), UC(to_char(s_last_pressed)));
                // oled_write_ln(buf, false);

                // oled_write_P(PSTR("Char: "), false);
                // oled_write_char(to_char(s_last_pressed), false);
            // }
        }
